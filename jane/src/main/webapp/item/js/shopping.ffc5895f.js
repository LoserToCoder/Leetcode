webpackJsonp([5], [function(t, e, a) {
	var n = a(1),
		i = a(35);
	a(55), a(67), n(function() {
		function t() {
			var t = n(".ctg-menu-list"),
				e = location.hash.slice(1);
			e && 2 === e.split("=").length && t.find("h3 span").text(e.split("=")[1])
		}
		...
		function e() {
			...
			n.each(e, function() {
				...
				if(t.indexOf("#!new") >= 0) var a = e + "#!new";
				else var a = e.replace("#!new", "");
				n(this).attr("href", a)
			})
		}

		function a() {
			var t = parseInt(n.G.getCookie("sh_count")),
				e = n("#sh-count");
			t ? 1 !== t && (t += 5, t > 2e3 && (t = Math.floor(1e3 * Math.random() + 1e3)), e.removeClass("dn").find("u").text(t), n.G.setCookie("sh_count", t)) : (t = Math.floor(1e3 * Math.random() + 1e3), e.removeClass("dn").find("u").text(t), n.G.setCookie("sh_count", t)), n("#newcount").click(function(t) {
				n.G.setCookie("sh_count", "1"), e.addClass("dn")
			})
		}

		function o() {
			var t = n(".hsh-items").find("li"),
				e = n(".sh-detail").find("li");
			t.click(function() {
				var a = n(this).index();
				if(!(a >= 7)) {
					e.hide(), e.eq(a).show(), t.removeClass("acur"), n(this).addClass("acur");
					var i = n(this).css("background-color");
					n(".sh-detail").css({
						"border-color": i
					})
				}
		...
		i.wooInit(null, null, 244, 20, null, !0), n(".sh-carousel-item").carousel({
			action: ".sh-carousel-point",
			eventType: "click",
			time: 5e3,
			animateType: "move",
			carouselWrap: ".sh-carousel-content",
			lazyLoadImg: ".sh-carousel-img"
		}), n(document).on("click", ".ctg-menu-newhot .woo-swa", function() {
			e()
		}), t(), e(), a(), o(), n("#m-s").addClass("cur"), n("#sh-tmh").delegate("a.img", "mousedown", function(t) {
			n.G.gaq("/_trc/Recommend/shopping/top_tmh_img")
		}), n("#sh-tmh").delegate("a.desc", "mousedown", function(t) {
			n.G.gaq("/_trc/Recommend/shopping/top_tmh_desc")
		}), n(".hsh-items").delegate(".hsh-item0 a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/nav/shopping")
		}), n(".hsh-items").delegate(".hsh-item7 a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/nav/temaihui")
		}), n(".hsh-items").delegate(".hsh-item1 a,.hsh-item2 a,.hsh-item3 a,.hsh-item4 a,.hsh-item5 a,.hsh-item6 a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/nav/category")
		}), n(".sh-detail").delegate("a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/nav/recommend")
		}), n(".sh-carousel-item").eq(0).delegate("a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/banner/1")
		}), n(".sh-carousel-item").eq(1).delegate("a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/banner/2")
		}), n(".sh-carousel-item").eq(2).delegate("a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/banner/3")
		}), n(".sh-carousel-item").eq(3).delegate("a", "mousedown", function(t) {
			n.G.gaq("/_trc/shopping/banner/temaihui")
		}), n(".dt-carousel-item").carousel({
			...
			callback: function(t, e, a, i, o) {
				var r = a.find(".dt-carousel-title").html(),
					s = n(".dt-carousel-action-title");
				s.html(r), n(".dt-carousel-item").mouseover(function() {
					o()
				}).mouseout(function() {
					i()
				})
			}
		}), n("#dt-carousel").on("a", "mousedown", function() {
			var t = n(this),
				e = t.closest("#dt-carousel").find("a"),
				a = e.index(t);
			n.G.gaq("/_trc/NIdex/_/focus_" + a + "__" + n(this).attr("href"))
		})
	})
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e, a) {
	var n;
	...
	! function(t, e) {
		...
		var c = function(e, a) {
				...
				function u(t) {
					var e;
					e = "print" === t ? C : "include" === t ? x : l.hasOwnProperty(t) ? "$helpers." + t : "$data." + t, w += t + "=" + e + ","
				}
				var f = t.openTag,
					p = t.closeTag,
					h = t.parser,
			...
			function(a, n) {
				...
				e.extend(k, {
						...
						if(this.$footer.css("display", 1 == D ? "block" : "none"), w[n])(w[n].lazyAdding || w[n].loading) && h || (w[n].lazyAdding = !0, w[n].scrollLoading = !0, y[n].standardUnitCount = 0, y[n].setCols(), w[n].refreshPage(i));
							...
							this.masn[n] = y[n] = new k.Masn(P, {
								...
								onArrange: function(t) {
									t.length && (E = 2, W = t), w[n] && (w[n].caching = 1, w[n].$data = t), s && a.clearTimeout(s), k._onscroll()
								},
								initAppendCounts: A,
								sinkWhat: G,
								firstHeight: H,
								...
								$data: W,
								nextMode: M,
								analyzeResponse: d ? d.analyzeResponse[I] : e.noop,
								lazyAdd: function(t) {
									var i = this,
										o = i.config;
									...
									var b = d && d.render[I] ? d.render[I](v) : v;
					...
					_placeEachUnit: function(t, a, n, i, o, r, s, l) {
						...
						var S = i.add(o).removeClass("woo-wait"),
							I = r ? S.parent() : v.append(S);
						if(y = I.find(a.unit).not(".woo-f,.woo-wait").each(function(n, i) {
								var o = e(i),
									r = o.data("id");
								(0 === n && l && !a.rightAlignFirstBlock || n === x - 1 && l && a.rightAlignFirstBlock) && (c = t.prePlaceUnit(o, C, x, s, l), d = c[0], u = c[1], f = c[2], p = c[3], h = c[4], m = '<div class="woo woo-f co' + u + " " + (h ? "woo-spcol" : "") + '" data-ht="' + p + '" data-idx="' + t.unitCount + '" style="position:absolute;overflow:hidden;top:' + d + "px;left:" + f + "px;width:" + (t.firstWidth - a.columnMargin) + 'px;"></div>', w += m, g = P ? I.find(".woo-f:first").css({
									left: f,
									top: d
								}) : e(m).append(a.sinkWhat), g.data("idx", t.unitCount), _ = n, k.conf.exrecycle && t.exCoordMap(d, p, u), t.unitCount++), c = t.prePlaceUnit(o, C, x, s), d = c[0], u = c[1], f = c[2], p = c[3], h = c[4], w += '<div class="' + a.unit.substr(1) + " co" + u + (h ? " woo-spcol" : "") + '" ' + (r ? 'data-id="' + r + '"' : "") + ' data-ht="' + p + '" data-idx="' + t.unitCount + '" style="top:' + d + "px;left:" + f + 'px;"></div>', o.css({
									top: d,
									left: f
							...
							var j = y.toArray();
							y = e(j.slice(0, _).concat(g ? g.toArray() : [], j.slice(_)))
						}
				...
				var i = n.dir ? 1 : -1,
					...
					s = function(a) {
						...
						var n, s, c = t(this),
							...
							y = l.outerHeight(),
							k = 12,
							C = -1 === i ? d.top + f + k : d.top - y - k,
							x = d.left - w / 2 + u / 2;
						n = h - y - k, C = k > C ? k : C > n ? n : C, n = p - w - k, x = k > x ? k : x > n ? n : x, n = C - k, s = x - k, t("html").animate({
							scrollTop: m > n ? n : (n = C + k + y - b) > m ? n : "+=0",
	...
	(function(t) {
		...
		! function(t) {
			...
			function u(a, n, i, r, s) {
				k = !1, C = ["收集", "收集到", "收集"], p("/napi/blog/forward/", s, i), m.css("display", "block"), l(), o();
			...
			function f(a, n, i, r, s, c, d, u) {
				k = u, C = ["编辑", "转移到", "提交"], p("/napi/blog/edit/", s, i, c, d, u), m.css("display", "block"), l(), o();
				...
				if(w.length) var y = w.data("height"),
					x = w.data("width"),
					y = 200 * y / x,
					_ = t("<img />").attr("src", w.attr("src")).appendTo(v);
				else {
			...
			function p(e, i, l, u, f, p) {
				...
				if(m && m.length) t.G.store(m);
					...
					m = t('<div id="re-favorite"><form action="' + e + '" target="_self"><div id="re-head"><a id="re-close" target="_self" href="javascript:;" onclick="SUGAR.PopOut.closeMask();">关闭</a><h1>' + C[0] + '</h1></div><div id="re-cont" class="clr"><div id="re-left" class="l"></div> <div id="re-right" class="r"> <p>' + C[1] + '</p> <div id="re-albumsel"><input class="dn" type="text" data-optional="1" name="album_id"><a id="re-albumtrig" href="javascript:;">默认专辑</a><span id="re-onlyeditwds"></span></div><textarea name="msg"' + ("编辑" == C[0] && (parseInt(l) || t.G.isSTAFF()) ? ' class="txa" ' : ' class="txa txa-no"  readonly="true"') + ' data-optional="1" ></textarea> <div id="re-subpan" class="u-chk clr"> <a href="javascript:;" class="abtn l "><button type="submit"><u>' + C[2] + "</u></button></a>" + (void 0 != typeof BIND_SITES && BIND_SITES.sina ? '<input id="re-sycn-sina" type="checkbox" value="1" class="chk s-sina" name="syncpost" /><label class="s-sina" title="同步到新浪微博" for="re-sycn-sina">同步</label><div class="re-mbsite s-sina">新浪</div>' : "") + '<div id="re-poststat"></div></div></div></div><input id="re-inp-parent" type="hidden" name="parent" value="" data-optional="1" /></form></div>'), t.G.store(m);
				...
				if(p ? (b.addClass("re-onlyedit"), t("#re-subpan").find("input,label,div.re-mbsite").css("visibility", "hidden")) : (b.removeClass("re-onlyedit"), t("#re-subpan").find("input,label,div.re-mbsite").css("visibility", "visible")), "undefined" != typeof u) u = u || "", f = f || "默认专辑", r(u, f);
					...
					var _ = t.Bom.getSubCookie("sgt", "ai" + t.G.getUSERID()) || "",
						P = t.Bom.getSubCookie("sgt", "an" + t.G.getUSERID()) || "默认专辑";
					r(_, P)
				}
				w.attr("action", e), m.find("h1").html(C[0]).end().find("#re-right p").eq(0).html(C[1]).end().find(".abtn u").html(C[2])
			}
							...
							return o ? void(a.hasClass("abtn-no") || (a.addClass("abtn-no"), t.ajax({
								...
								mysuccess: function(e, n) {
									var o = t(".dt-avatar").attr("src"),
										r = t(['<li><a href="dongtai.html" target="_blank"><img src="', o, '" width="24" height="24"></a><p><a href="dongtai.html" target="_blank">我</a><br/><span>', e.data.content.replace(/<br\s*\/?>/i, " ").replace(/@[\u2E80-\u9FFF\d\w]{1,20}/gi, ""), "</span></p></li>"].join(""));
		...
		! function() {
			t.G && !t.G.reTop && (t.G.reTop = function() {
				var e, a = t(window),
					...
					l = t("#dt-backtotop");
				if(!l.length) {
					s = t('<div id="dt-side-combo" ><a id="dt-backtotop" class="dt-backtotop" href="javascript:;">回到顶部</a><a class="dt-app" href="/app/duitang/">手机应用</a><a class="dt-report" href="javascript:void(null)"></a></div>').sidepop({
						id: "dt-side-combo",
						dockSide: "right",
						width: 48,
						height: 142,
