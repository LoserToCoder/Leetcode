...
<meta name="description" content="H后台管理系统">
</head>
<body>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="../commons/hcharts/Highcharts/5.0.6/js/highcharts.js"></script>
<script type="text/javascript" src="../commons/hcharts/Highcharts/5.0.6/js/modules/exporting.js"></script>
