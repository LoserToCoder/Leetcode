...
<!--[if lt IE 9]>
<script type="text/javascript" src="${APP_PATH}/commons/html5.js"></script>
<script type="text/javascript" src="${APP_PATH}/commons/respond.min.js"></script>
<![endif]-->
...
<link rel="stylesheet" type="text/css" href="${APP_PATH}/admin/lib/iconfont/iconfont.css" />
