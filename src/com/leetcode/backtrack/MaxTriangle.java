...
public class MaxTriangle {
    ...
    public void backtrack(int [] nums, int l, int r, List<Integer> results){
    ...
    public int largestPerimeterWithSort(int []nums){
        Arrays.sort(nums);
        int n = nums.length-1;
        for(int i= n ;i>=2;i--){
    ...
    public static void main(String[] args) {
        ...
        int max = new MaxTriangle().largestPerimeter(nums);
